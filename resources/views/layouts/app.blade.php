        ...
        <div class="sidebar">
            <div class="sidebar-inner">
                <div class="sidebar-logo">
                    <div class="peers ai-c fxw-nw">
                        <div class="peer peer-greed"><a class="sidebar-link td-n" href="#">
                                <div class="peers ai-c fxw-nw">
                                    <div class="peer">
                                        <div class="logo"><img src="./Dashboard_files/logo.webp" alt=""></div>
                                    </div>
                ...
                <ul class="sidebar-menu scrollable pos-r ps">
                    <li class="nav-item mT-30 actived"><a class="sidebar-link" href="#"><span
                    ...
                    <li class="nav-item"><a class="sidebar-link"
                            href="https://colorlib.com/polygon/adminator/email.html"><span class="icon-holder"><i
                                    class="c-brown-500 ti-email"></i> </span><span class="title">Email</span></a>
                    </li>
                    <li class="nav-item"><a class="sidebar-link"
                            href="https://colorlib.com/polygon/adminator/compose.html"><span class="icon-holder"><i
                                    class="c-blue-500 ti-share"></i> </span><span class="title">Compose</span></a>
                    </li>
                    <li class="nav-item"><a class="sidebar-link"
                            href="https://colorlib.com/polygon/adminator/calendar.html"><span class="icon-holder"><i
                                    class="c-deep-orange-500 ti-calendar"></i> </span><span
                                class="title">Calendar</span></a></li>
                    <li class="nav-item"><a class="sidebar-link"
                            href="https://colorlib.com/polygon/adminator/chat.html"><span class="icon-holder"><i
                                    class="c-deep-purple-500 ti-comment-alt"></i> </span><span
                                class="title">Chat</span></a></li>
                    <li class="nav-item"><a class="sidebar-link"
                            href="https://colorlib.com/polygon/adminator/charts.html"><span class="icon-holder"><i
                                    class="c-indigo-500 ti-bar-chart"></i> </span><span class="title">Charts</span></a>
                    </li>
                    <li class="nav-item"><a class="sidebar-link"
                            href="https://colorlib.com/polygon/adminator/forms.html"><span class="icon-holder"><i
                                    class="c-light-blue-500 ti-pencil"></i> </span><span class="title">Forms</span></a>
                    </li>
                    <li class="nav-item dropdown"><a class="sidebar-link"
                            href="https://colorlib.com/polygon/adminator/ui.html"><span class="icon-holder"><i
                    ...
                    <li class="nav-item dropdown"><a class="dropdown-toggle" href="javascript:void(0);"><span
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="sidebar-link"
                                    href="https://colorlib.com/polygon/adminator/basic-table.html">Basic Table</a>
                            </li>
                            <li><a class="sidebar-link"
                                    href="https://colorlib.com/polygon/adminator/datatable.html">Data Table</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown"><a class="dropdown-toggle" href="javascript:void(0);"><span
                                class="icon-holder"><i class="c-purple-500 ti-map"></i> </span><span
                                class="title">Maps</span> <span class="arrow"><i
                                    class="ti-angle-right"></i></span></a>
                        <ul class="dropdown-menu">
                            <li><a href="https://colorlib.com/polygon/adminator/google-maps.html">Google Map</a></li>
                            <li><a href="https://colorlib.com/polygon/adminator/vector-maps.html">Vector Map</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown"><a class="dropdown-toggle" href="javascript:void(0);"><span
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="sidebar-link"
                                    href="https://colorlib.com/polygon/adminator/blank.html">Blank</a></li>
                            <li><a class="sidebar-link" href="https://colorlib.com/polygon/adminator/404.html">404</a>
                            </li>
                            <li><a class="sidebar-link" href="https://colorlib.com/polygon/adminator/500.html">500</a>
                            </li>
                            <li><a class="sidebar-link" href="https://colorlib.com/polygon/adminator/signin.html">Sign
                                    In</a></li>
                            <li><a class="sidebar-link" href="https://colorlib.com/polygon/adminator/signup.html">Sign
                                    Up</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown"><a class="dropdown-toggle" href="javascript:void(0);"><span
            ...
            <div class="header navbar">
                <div class="header-container">
                    <ul class="nav-left">
                        ...
                        <li class="search-input"><input class="form-control" type="text" placeholder="Search...">
                        </li>
                    </ul>
                    <ul class="nav-right">
                                    ...
                                    <ul class="ovY-a pos-r scrollable lis-n p-0 m-0 fsz-sm ps">
                                        <li><a href="#"
                                                ...
                                                <div class="peer mR-15"><img class="w-3r bdrs-50p"
                                                        src="./Dashboard_files/1.jpg" alt=""></div>
                                                <div class="peer peer-greed"><span><span class="fw-500">John
                                                            Doe</span> <span class="c-grey-600">liked your <span
                                        ...
                                        <li><a href="#"
                                                class="peers fxw-nw td-n p-20 bdB c-grey-800 cH-blue bgcH-grey-100">
                                                <div class="peer mR-15"><img class="w-3r bdrs-50p"
                                                        src="./Dashboard_files/2.jpg" alt=""></div>
                                        ...
                                        <li><a href="#"
                                                class="peers fxw-nw td-n p-20 bdB c-grey-800 cH-blue bgcH-grey-100">
                                                <div class="peer mR-15"><img class="w-3r bdrs-50p"
                                                        src="./Dashboard_files/3.jpg" alt=""></div>
                        ...
                        <li class="notifications dropdown"><span class="counter bgc-blue">3</span> <a href="#"
                            ...
                            <ul class="dropdown-menu">
                                                    ...
                                                    <div>
                                                        <div class="peers jc-sb fxw-nw mB-5">
                                                            ...
                                                            <div class="peer"><small class="fsz-xs">5 mins
                                                                    ago</small></div>
                                                        </div><span class="c-grey-600 fsz-sm">Want to create your own
                                                            customized data generator for
                                                            your app...</span>
                                                    </div>
                                                </div>
                                            </a></li>
                                ...
                                <li class="pX-20 pY-15 ta-c bdT"><span><a
                                            href="https://colorlib.com/polygon/adminator/email.html"
                        ...
                        <li class="dropdown"><a href="#"
                                ...
                                aria-expanded="false">
                                <div class="peer mR-10"><img class="w-2r bdrs-50p" src="./Dashboard_files/10.jpg"
                                        alt=""></div>
                            ...
                            <ul class="dropdown-menu fsz-sm">
                                ...
                                <li><a href="https://colorlib.com/polygon/adminator/email.html"
                                        class="d-b td-n pY-5 bgcH-grey-100 c-grey-700"><i class="ti-email mR-10"></i>
