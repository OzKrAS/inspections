    ...
    <head>
        ...
        <meta name="author" content="http://rgpacolombia.gov.co/">
        <meta name="keyword" content="Sistema de inspecciones">
        <link rel="shortcut icon" href="img/aunap.png">
        <title>Sistema Inspecciones - Alto-Sentido</title>
    ...
    <header class="app-header navbar">
            ...
            <li class="nav-item d-md-down-none">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a class="dropdown-item" href="#">
                        <i class="fa fa-envelope-o"></i> Not1
                        <span class="badge badge-success">3</span>
                    </a>
                    <a class="dropdown-item" href="#">
                        <i class="fa fa-tasks"></i> Not2
        ...
        <footer class="app-footer">
            <span><a href="http://www.codesinfo.com/">Alto Sentido</a> &copy; 2022</span>
            <span class="ml-auto">Desarrollado por <a href="http://www.altosentido.net/">OzKr</a></span>
        </footer>
