    ...
    <div class="container-fluid">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <strong class="lead">Gestión Material Arte de Pesaca</strong>          
          <button
            v-if="edo"
            type="button"
            @click="showData()"
              ...
              <md-card-content>
                <div class="md-layout">
                  <md-field md-clearable :class="getValidationClass('name')">
                    ...
                    >Olvidaste ingresar el nombre del material de arte de pesca</span>
    ...
    listData() {
      ...
      axios
        ...
        .then(function (response) {
          ...
          me.arrayData = respuesta.materials;
