          ...
          <div class="card-body">
            <form action method="post" enctype="multipart/form-data" class="form-horizontal">
              <md-card-content>
                ...
                <div class="md-layout">
                  ...
                  <div class="md-layout-item">
                    <md-field>
                      ...
                      <md-select v-model="office" name="office" id="office"
                                 placeholder="Seleccione una oficina (Office)">
                ...
                <div>
                  <br>
                  <strong class="text-muted">Nota: Para completar los datos de la tabla debe hacer click en cada uno de
                    los puntos de la imagen (A, B, C, D, E, F, G, H, I).</strong>
                </div>
                <br>
                ...
                <label>DETs con salida inferior: si la circunferencia del DET es ≥ a 120 ", se requieren 2 boyas, si es
                  menor solo se requiere una boya</label>
                <label>Exención: red de prueba (chango) La longitud de la relinga superior debe ser de 12 pies o menos,
                  y la longitud de la relinga inferior debe ser de 15 pies o menos</label>
                <div class="md-layout">
                  <div class="md-layout-item">
                    <md-field>
...
export default {
  ...
  methods: {
    ...
    createPdf(data = []) {
      ...
      doc.setFontSize(10);
      doc.text(`DETs con salida inferior: si la circunferencia del DET es ≥ a 120", se requieren 2 boyas, si es menor solo se requiere una boya.`, 15, 145, {
        align: 'justify',
        lineHeightFactor: 1,
        maxWidth: 110
      });
      doc.setFontSize(10);
      doc.text(`Exención: red de prueba (chango)  La longitud de la relinga superior debe ser de 12 pies o menos, y la longitud de la relinga inferior debe ser de 15 pies o menos`, 15, 153, {
        align: 'justify',
        lineHeightFactor: 1,
        maxWidth: 160
      });
