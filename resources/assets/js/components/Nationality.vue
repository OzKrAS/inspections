              ...
              <md-card-content>
                <div class="md-layout">
                  <md-field md-clearable :class="getValidationClass('name')">
                    ...
                    >Olvidaste ingresar un país</span>
...
export default {
  ...
  methods: {
    ...
    updateData() {
      ...
      axios
        .put("/nationality/update", {
          name: this.form.name.toUpperCase(),
          id: this.id_nationality
        })
        .then(function(response) {
          me.hideForm();
    ...
    deleteData(data = []) {
      swal({
        title: "Esta seguro de Eliminar el país " + data["name"],
        type: "warning",
