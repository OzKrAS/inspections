...
class DetailDetFlapController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        ->select('detail_det_flaps.babor3','detail_det_flaps.babor4','detail_det_flaps.estribor3','detail_det_flaps.estribor4','detail_det_flaps.punto2','detail_det_flaps.tituloModal') 
