...
class UserController extends Controller
{
    ...
    public function login(Request $request){
        ...
        if( password_verify( $data['password'],$usuario[0]->password)){
            ...
            $headers=array('Access-Control-Allow-Origin'=>'http://68.183.50.234:12345/api', 'Access-Control-Allow-Methods'=>'GET, POST, PUT, DELETE', 'Access-Control-Allow-Headers'=>'X-Requested-With, Content-Type, X-Token-Auth, Authorization');
